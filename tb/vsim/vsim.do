...
add wave -radix hexadecimal     axis_uart_transceiver_inst/axis_uart_rx_inst/uart_buf
...
add wave -radix unsigned        axis_uart_transceiver_inst/axis_uart_rx_inst/majority_in
add wave -radix unsigned        axis_uart_transceiver_inst/axis_uart_rx_inst/majority_out

add wave -radix unsigned        axis_uart_transceiver_inst/axis_uart_rx_inst/state_wdt
add wave -radix hexadecimal     axis_uart_tb/uart_reg
add wave -radix unsigned        axis_uart_tb/uart_parity
add wave -radix unsigned        axis_uart_transceiver_inst/axis_uart_rx_inst/count_parity_byte
